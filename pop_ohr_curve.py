...
def plot_orig(arg1 , label, marker, every):
    if label == "orig":
        ...
        f = open(d + "/" + arg1 + "/" + "popularity_desc_" + str("all") + ".txt", "r")        
    else:
        f = open(d + "/" + arg1 + "/pop_generated/" + "footprint_desc_" +str("pop_all") + ".txt", "r")        
...
i = 0
plot_orig("v", "gen", markers[i], 10000)
i+= 1
plot_orig("v", "orig", markers[i], 10000)
i+= 1
plot_orig("v", "pop", markers[i], 10000)
i+= 1
# plot_orig("w", "gen", markers[i], 10000)
# i+= 1
# plot_orig("w", "orig", markers[i], 10000)
# i+= 1
