...
def plot_orig(arg1 , label, marker, every):
    if label == "orig":
        ...
        f = open(d + "/" + arg1 + "/generated/" + "footprint_desc_" +str("all") + ".txt", "r")        
...
i+= 1
plot_orig("w", "gen", markers[i], 2500)
i+= 1
plot_orig("w", "orig", markers[i], 2500)
i+= 1
plot_orig("tc", "gen", markers[i], 2500)
i+= 1
plot_orig("tc", "orig", markers[i], 2500)
i+= 1
