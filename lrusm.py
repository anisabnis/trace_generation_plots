...
def plot_orig(arg1 ,arg2, label, marker, every):
    if label == "orig":
        ...
        if arg2 == "req":
            f = open(d + "/" + arg1 + "/generated/" + "footprint_desc_" +str("lrusm") + ".txt", "r")
        else:
            f = open(d + "/" + arg1 + "/generated/" + "byte_footprint_desc_" +str("lrusm") + ".txt", "r")
...
plot_orig("v", "req", "lrusm", markers[i], 5000)
i+= 1
plot_orig("v", "byte", "lrusm", markers[i], 6000)
i+= 1
plot_orig("v", "req", "orig", markers[i], 10000)
i+= 1
plot_orig("v", "byte", "orig", markers[i], 6000)
i+= 1
